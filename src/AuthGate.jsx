...
export default function AuthGate({ children, onSessionChange }) {
  ...
  function captureAuth(event) {
    // Très important : ne jamais intercepter les boutons à l'intérieur de la fenêtre d'authentification.
    // Sinon le clic sur « Se connecter » remontait jusqu'ici, annulait le submit et effaçait le mot de passe.
