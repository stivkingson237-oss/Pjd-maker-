...
.pjd-admin-shell .verify{background:#111827;color:#fff}.pjd-admin-shell .promo{background:#f97316;color:#fff}.pjd-admin-shell .chat{background:#fff;color:#111827;border:1px solid #e5e7eb}
.pjd-admin-shell~div[style*="position:fixed"]{display:none!important}
@media(max-width:900px){
 .pjd-admin-shell header{position:relative!important}
 .pjd-admin-shell main{padding:14px 12px 165px!important}
 ...
 .pjd-admin-shell .pjd-admin-tools button{text-align:center;padding:10px 6px;font-size:11px}
}
